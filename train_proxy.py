...
if __name__ == '__main__':
    ...
    df_train = pd.read_csv('Data/train_data_proxy.csv')
    ...
    history = model.fit_generator(generator(df_train, img_data_train), steps_per_epoch=num_train_batches, epochs=100, callbacks=callbacks_list, validation_data=generator(df_val, img_data_val), initial_epoch=0, validation_steps=num_val_batches)
